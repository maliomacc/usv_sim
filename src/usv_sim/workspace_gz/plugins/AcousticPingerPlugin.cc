  ...
  sim::EntityComponentManager &_ecm)
{
  ...
  if (this->sdf->HasElement("range_noise"))
  {
    ...
    {
      ignerr << "<range_noise> must contain a noise tag" << std::endl;
    }
  }
  ...
  if (this->sdf->HasElement("bearing_noise"))
  {
    ...
    {
      ignerr << "<bearing_noise> must contain a noise tag" << std::endl;
    }
  }
  ...
  if (this->sdf->HasElement("elevation_noise"))
  {
    ...
    {
      ignerr << "<elevation_noise> must contain a noise tag" << std::endl;
    }
  }
  ...
  sim::EntityComponentManager &_ecm, sim::EventManager &_eventMgr)
{
  ...
  {
    ignerr << "AcousticPingerPlugin disabled" << std::endl;
    return;
  }
...
IGNITION_ADD_PLUGIN(AcousticPingerPlugin,
              sim::System,
              AcousticPingerPlugin::ISystemConfigure,
              AcousticPingerPlugin::ISystemPreUpdate)

IGNITION_ADD_PLUGIN_ALIAS(vrx::AcousticPingerPlugin,
