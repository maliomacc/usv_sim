...
void WavefieldPrivate::FillParameters()
{
  ...
  // size.
  ignition::msgs::Any sizeValue;
  sizeValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_VECTOR3D);
  ...
  // cell_count
  ignition::msgs::Any cellCountValue;
  cellCountValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_VECTOR3D);
  ...
  // number
  ignition::msgs::Any numberValue;
  numberValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_INT32);
  numberValue.set_int_value(this->number);
  (*params)["number"] = numberValue;

  // scale
  ignition::msgs::Any scaleValue;
  scaleValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  scaleValue.set_double_value(this->scale);
  (*params)["scale"] = scaleValue;

  // angle
  ignition::msgs::Any angleValue;
  angleValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  angleValue.set_double_value(this->angle);
  (*params)["angle"] = angleValue;

  // steepness
  ignition::msgs::Any steepnessValue;
  steepnessValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  steepnessValue.set_double_value(this->steepness);
  (*params)["steepness"] = steepnessValue;

  // amplitude
  ignition::msgs::Any amplitudeValue;
  amplitudeValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  amplitudeValue.set_double_value(this->amplitude);
  (*params)["amplitude"] = amplitudeValue;

  // period
  ignition::msgs::Any periodValue;
  periodValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  periodValue.set_double_value(this->period);
  (*params)["period"] = periodValue;

  // phase
  ignition::msgs::Any phaseValue;
  phaseValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  phaseValue.set_double_value(this->phase);
  (*params)["phase"] = phaseValue;

  // direction.
  ignition::msgs::Any directionValue;
  directionValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  ...
  // gain
  ignition::msgs::Any gainValue;
  gainValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
  gainValue.set_double_value(this->gain);
  (*params)["gain"] = gainValue;

  // tau
  ignition::msgs::Any tauValue;
  tauValue.set_type(ignition::msgs::Any_ValueType::Any_ValueType_DOUBLE);
