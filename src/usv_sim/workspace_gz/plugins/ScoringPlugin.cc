...
class ScoringPlugin::Implementation
{
  ...
  public: sim::Entity vehicleModel{ignition::gazebo::kNullEntity};
...
//////////////////////////////////////////////////
ignition::gazebo::Entity ScoringPlugin::VehicleEntity() const
{
...
void ScoringPlugin::OnFinished()
{
  if (!this->dataPtr->silent)
  {
    ignmsg << "ScoringPlugin::OnFinished at time=" 
