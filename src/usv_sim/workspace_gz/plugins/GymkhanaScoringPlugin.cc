...
{
  ignmsg << "GymkhanaScoringPlugin loaded" << std::endl;
}
...
/////////////////////////////////////////////////
void GymkhanaScoringPlugin::PreUpdate(const ignition::gazebo::UpdateInfo &_info,
...
IGNITION_ADD_PLUGIN(GymkhanaScoringPlugin,
              sim::System,
              ScoringPlugin::ISystemConfigure,
              ScoringPlugin::ISystemPreUpdate)

IGNITION_ADD_PLUGIN_ALIAS(vrx::GymkhanaScoringPlugin,
