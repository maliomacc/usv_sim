                        ...
                        sim::EventManager & /*_eventMgr*/)
{
  ...
  {
    ignerr << "Did not find SDF parameter wind_obj" << std::endl;
  }
  else
  {
    ...
    while (windObjSDF)
    {
      ...
      {
        ignerr << ("Did not find SDF parameter name") << std::endl;
      }
      else
      {
      ...
      {
        ignerr << ("Did not find SDF parameter link_name") << std::endl;
      }
      else
      {
      ...
      {
        ignerr << ("Did not find SDF parameter coeff_vector") << std::endl;
      }
      else
      {
      ...
      igndbg << obj.modelName << " loaded" << std::endl;
  ...
  ignmsg << "Wind direction unit vector = " << this->dataPtr->windDirection 
        << std::endl;
  ...
  ignmsg << "Wind mean velocity = " << this->dataPtr->windMeanVelocity 
        << std::endl;
  ...
  ignmsg << "var wind gain constants = " << this->dataPtr->gainConstant 
        << std::endl;
  ...
  ignmsg << "var wind time constants = " << this->dataPtr->timeConstant 
        << std::endl;
  ...
  ignmsg << "update rate  = " << this->dataPtr->updateRate << std::endl;
  ...
  ignmsg << "topic wind speed  = " << this->dataPtr->topicWindSpeed << std::endl;
  ...
  ignmsg << "Random seed value = " << seed << std::endl;
  ...
  ignmsg << "Var wind filter gain = " << this->dataPtr->filterGain << std::endl;
      ...
      {
        {
          ...
          if (!entity.empty())
          {
            ...
            igndbg << i.modelName << " initialized" << std::endl;
...
IGNITION_ADD_PLUGIN(vrx::USVWind,
              sim::System,
              USVWind::ISystemConfigure,
              USVWind::ISystemPreUpdate)

IGNITION_ADD_PLUGIN_ALIAS(vrx::USVWind,
                    "vrx::USVWind")
